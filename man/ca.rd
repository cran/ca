...
\usage{ca(obj, nd = NA, suprow = NA, supcol = NA, subsetrow = NA, subsetcol = NA)}
\arguments{
...
\references{Blasius, J. and Greenacre, M. J. (1994), Computation of correspondence analysis, 
            in ``Correspondence Analysis in the Social Sciences'', pp. 53-75, Academic Press, 
            London.\cr
            Greenacre, M.J. and Pardo, R. (2006), Subset correspondence analysis: visualizing relationships among a selected set of response categories from a questionnaire survey. Sociological Methods and Research, 35, forthcoming.}
